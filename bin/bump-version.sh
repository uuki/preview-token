...
#   - draft-preview-token.php  (plugin header: " * Version:     X.Y.Z")
...
sed -i.bak "s/^\( \* Version:     \).*/\1${VERSION}/" plugin/draft-preview-token.php
rm -f plugin/draft-preview-token.php.bak
