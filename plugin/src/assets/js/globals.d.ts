...
declare global {
  ...
  const drptPreviewData: DrptPreviewData | undefined

  interface DrptSettingsData {
    /** name attribute for origin inputs, e.g. "drpt_allowed_origins[]" */
    field:        string
  ...
  const drptSettingsData: DrptSettingsData
}
